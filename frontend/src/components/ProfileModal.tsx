...
export default function ProfileModal({ isOpen, onClose }: ProfileModalProps) {
  ...
  useEffect(() => {
    ...
    setName(user.name || '');
    setAbout(user.about || 'Hey there! I am using this chat app.');
    setAvatar(user.avatar || '');
    setPreview(user.avatar || '');
  }, [isOpen, user?._id, user?.name, user?.about, user?.avatar]);
          ...
          >
            ...
            <div className="px-8 pb-8">
              <div className="relative -mt-16 mb-6 flex justify-center">
                <div className="relative group cursor-pointer">
                  ...
                  <div
                    ...
                    className="absolute inset-0 rounded-full flex flex-col items-center justify-center bg-black/50 opacity-0 group-hover:opacity-100 group-focus-within:opacity-100 transition-opacity"
                  >
              ...
              <form onSubmit={handleSave} className="space-y-5">
                <div>
                  <label className="text-xs font-semibold uppercase tracking-wider text-muted mb-2 block ml-1">
                    Display Name
                  </label>
